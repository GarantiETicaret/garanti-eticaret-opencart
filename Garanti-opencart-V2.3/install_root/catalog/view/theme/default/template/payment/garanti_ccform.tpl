...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/garanti_form.css" />
<script src="catalog/view/javascript/garanti/jquery.card.js"></script>
<script src="catalog/view/javascript/garanti/jquery.payment.min.js"></script>
